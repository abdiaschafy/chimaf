...
class Fixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
         ...
         * PRODUITS VENDUS
         */
        $pointes80 = new Produit($pointes, 'PP80', 'PAQUET POINTES ORD.DE 80mm', 25, 278, '4000');
        $pointes90 = new Produit($pointes, '123C2', 'POINTES ORDINAIRES(PAQUET) 90mm', 25, 278, '4000');
        $manager->persist($pointes80);
        $manager->persist($pointes90);

        $autre1 = new Produit($autre, 'BCT1KG', 'BOITE COLLE TANGIT DE 1kg', 25, 278, '12500');
        $autre2 = new Produit($autre, 'BPD35', 'BRONZE PLEIN : diamètre 35', 25, 278, '135000');
        $autre3 = new Produit($autre, 'BPD40', 'BRONZE PLEIN : diamètre 40', 25, 278, '174000');
        $autre4 = new Produit($autre, 'BPD60', 'BRONZE PLEIN : diamètre 60', 25, 278, '384000');
        $autre5 = new Produit($autre, 'CV80', 'CADENAS VACHETTE DE 80mm HARDENED SHACKLE', 25, 278, '15000');
        $autre6 = new Produit($autre, 'CUAT', 'CARTE UNIVERSELLE AVEC TELECOMMANDE', 25, 278, '14500');
        ...
        $corniere1 = new Produit($corniere, 'COR30', 'CORNIERE DE 30', 25, 278, '8650');
        $corniere2 = new Produit($corniere, 'COR40', 'CORNIERE DE 40', 25, 278, '12500');
        $corniere3 = new Produit($corniere, 'SGGM3', 'SABLE GROS GRAIN EN m3', 25, 278, '12500');
        ...
        $tole1 = new Produit($tole, 'TAPN3m', 'TÔLE ACIER PLANE NOIRE 2000X1000.épaisseur3mm', 25, 278, '48500');
        $tole2 = new Produit($tole, 'TAPN2m', 'TÔLE ACIER PLANE NOIRE 2000X1000.épaisseur2mm', 25, 278, '29000');
        $tole3 = new Produit($tole, 'TFB30', 'TOLE FAITIERE BORD de 30', 25, 278, '5000');
        $tole4 = new Produit($tole, 'TB610X6m', 'TOLE BAC de 6/10e X6m', 25, 278, '34500');
        $manager->persist($tole1);
        $manager->persist($tole2);
        $manager->persist($tole3);
        $manager->persist($tole4);

        $balais1 = new Produit($balais, 'BCO30cm', 'BALAIS COCO DE 30 cm', 25, 278, '1300');
        $balais2 = new Produit($balais, 'BCO40cm', 'BALAIS COCO DE 40 cm', 25, 278, '1400');
        $balais3 = new Produit($balais, 'BCOTN', 'BALAIS CONTONNIER', 25, 278, '3800');
        $balais4 = new Produit($balais, 'BPDR', 'BALAIS PAILLE DE RIZ', 25, 278, '6800');
        $balais5 = new Produit($balais, 'MAROC', 'MACHETTE(CROCO)', 25, 278, '3500');
        ...
        $jet1 = new Produit($jet, 'JBD70', 'JET EN BRONZE diamètre 70', 25, 278, '235000');
        $jet2 = new Produit($jet, 'JBD50', 'JET EN BRONZE diamètre 50', 25, 278, '95000');
        $jet3 = new Produit($jet, 'JAP40X1m', 'JET ACIER PLEIN DE 40X1m', 25, 278, '27000');
        $jet4 = new Produit($jet, 'JAP60X1m', 'JET ACIER PLEIN DE 60X1m', 25, 278, '40000');
        $jet5 = new Produit($jet, 'JAP35X1m', 'JET EN INOX DE 35mmX1m', 25, 278, '80000');
        $jet6 = new Produit($jet, 'JAP80X1m', 'JET ACIER PLEIN 80X1m', 25, 278, '100000');
        ...
        $outilBureau1 = new Produit($outilBureau, 'OTEAGR', 'OTE-AGRAFFE', 25, 278, '1200');
        $outilBureau2 = new Produit($outilBureau, 'POST', 'PORTE STYLOS', 25, 278, '2500');
        $outilBureau3 = new Produit($outilBureau, 'RG300P', 'REGISTRE DE 300 PAGES', 25, 278, '7000');
        $outilBureau4 = new Produit($outilBureau, 'FB2300RPG', 'FEUTRE BIC 2300 (rouge) POUR GRAVURE', 25, 278, '600');
        $outilBureau5 = new Produit($outilBureau, 'CCPC', 'CHEMISE CARTONNEE POUR CLASSEMENT', 25, 278, '350');
        $outilBureau6 = new Produit($outilBureau, 'ENCRO', 'ENCRIER ROUGE', 25, 278, '1000');
        $outilBureau7 = new Produit($outilBureau, 'BCRB50', 'BIC COULEUR ROUGE BOITE DE 50', 25, 278, '160');
        $outilBureau8 = new Produit($outilBureau, 'BCBB50', 'BIC COULEUR BLEUE BOITE DE 50', 25, 278, '160');
        $outilBureau9 = new Produit($outilBureau, 'BCNB50', 'BIC COULEUR NOIRE BOITE DE 50', 25, 278, '160');
        ...
        $securite1 = new Produit($securite, 'CV54mm', 'CADENAS VACHETTE DE 54 mm', 25, 278, '9000');
        $securite2 = new Produit($securite, 'SCV3458C12', 'SERRURE A CANON VACHETTE 3458-C-12/LAPERCHE', 25, 278, '35000');
        $securite3 = new Produit($securite, 'SDWC', 'SERRURE DE DOUCHE « WC »', 25, 278, '15000');
        $securite4 = new Produit($securite, 'CUHRR22', 'COMPRESSEURS UH ROTATIFS R22. 3CV', 25, 278, '215000');
        $securite5 = new Produit($securite, 'CUHPR22', 'COMPRESSEURS UH A PISTON R22. 3CV-240V', 25, 278, '285000');
        $securite6 = new Produit($securite, 'CV131380m', 'CADENAS VACHETTE 1313-80mm', 25, 278, '11500');
        $securite7 = new Produit($securite, 'CLSN15', 'CLIMATISSEUR SPLIT NASCO. 1,5CV', 25, 278, '280000');
        ...
        $bois2 = new Produit($bois, 'CPSAP8mm', 'CONTRE PLAQUET(SAPPEL) DE 8 mm', 25, 278, '17500');
        $bois3 = new Produit($bois, 'DICELSM', 'DILUANT CELLULOSIQUE(en litre) smalto', 25, 278, '1500');
        $bois4 = new Produit($bois, 'VEBRCELSM', 'VERNIS BRILLANTT CELLULOSIQUE en litre smalto', 25, 278, '7500');
        $bois5 = new Produit($bois, 'FODCELSM', 'FOND DUR CELLULOSIQUE smalto', 25, 278, '7800');
        $bois6 = new Produit($bois, 'TAAC', 'TAMBOUR AUTO-COLLANT', 25, 278, '4500');
        $bois7 = new Produit($bois, 'PAU120', 'PAQUET AUTO-COLLANT DE 120', 25, 278, '25000');
        $bois8 = new Produit($bois, 'PAU80', 'PAQUET AUTO-COLLANT DE 80', 25, 278, '25000');
